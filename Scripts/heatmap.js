...
function setDataToUse() {
    dataToUse = [];
        var query =
       "select col5, col6 from 1TFWBEKj6Xf-M5xeCcgNgl3SkTvb_lhVPy9riUzXO where col0 = '2006' and col1 = 1 and col2 = 1 and col3 = 1 and col6 >= 1 and col6 <= 6";
        query = buildQuery();
